...
class TestDesignDecisionGeneration:
    ...
    def test_generates_decision_for_story(self) -> None:
    ...
    def test_generates_multiple_decisions(self) -> None:
    ...
    def test_decision_has_valid_type(self) -> None:
    ...
    def test_decision_has_description(self) -> None:
    ...
    def test_decision_has_created_at(self) -> None:
...
class TestDesignDecisionEmptyInput:
    ...
    def test_empty_stories_returns_empty_list(self) -> None:
        ...
        decisions = _generate_design_decisions([])
...
class TestDesignDecisionIdUniqueness:
    ...
    def test_sequential_decisions_have_unique_ids(self) -> None:
