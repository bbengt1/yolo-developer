...
class TestADRGeneration:
    ...
    def test_generates_adr_for_technology_decision(self) -> None:
    ...
    def test_generates_adr_for_pattern_decision(self) -> None:
    ...
    def test_adr_id_format(self) -> None:
    ...
    def test_adr_has_title(self) -> None:
    ...
    def test_adr_has_context(self) -> None:
    ...
    def test_adr_has_decision(self) -> None:
    ...
    def test_adr_has_consequences(self) -> None:
    ...
    def test_adr_links_to_stories(self) -> None:
...
class TestADREmptyInput:
    ...
    def test_empty_decisions_returns_empty_list(self) -> None:
...
class TestADRIdUniqueness:
    ...
    def test_sequential_adrs_have_unique_ids(self) -> None:
